    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('motivo', models.CharField(blank=True, max_length=40, null=True)),
                ('monto', models.CharField(blank=True, max_length=40, null=True)),
                ('fecha', models.DateField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CRUD.REGISTRO_AGRICOLA')),
            ],
            options={
                'ordering': ['id'],
            },
